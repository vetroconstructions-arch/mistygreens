...
const MODAL_HTML = `<!-- Standard Concierge Component Retained (Hidden below fold) --> <div class="concierge-modal" id="heritage-concierge" style="display:none;"></div>`; // Condensed for payload
